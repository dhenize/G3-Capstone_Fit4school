    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 bg-gray-100 p-4">
        ...
        <div className="flex items-center gap-6 mb-6">
          <h3 className="text-sm font-medium mx-2">Today is Monday, September 29, 2025</h3>
          <h3 className="text-sm font-medium">10:00:00 AM</h3>
          
          <div className="bg-white rounded-lg shadow h-10 w-64 ml-15">
            <p className="flex text-sm font-medium items-center justify-center mt-2">Sept. 22, 2025 - Sept. 29, 2025</p>
          </div>

          <div className="bg-white rounded-lg shadow h-10 w-36">
            <p className="flex text-sm font-medium items-center justify-center mt-2">New User</p>
          </div>

          <div className="bg-white rounded-lg shadow h-10 w-30">
            <p className="flex text-sm font-medium items-center justify-center mt-2">Audit Log</p>
          </div>
        </div>
